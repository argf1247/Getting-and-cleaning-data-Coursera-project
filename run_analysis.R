## Course project "Getting and claning data"
# This code runs in Windows 7
# The route is C:/Users/NameUser/Documents/R/run_analysis.R
#
# Download the file with raw data
...
write.table(tidy_data, file = "./UCI HAR Dataset")
